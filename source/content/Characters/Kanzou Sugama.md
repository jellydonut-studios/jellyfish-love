...
- "洌": Cold
- "鎌": Scythe
	- He was named for the Japanese name of the jellyfish, サムクラゲ (*Samu Kurage*)- translating to cold jellyfish. I know the kanji here isn't the correct one, but I really wanted to use "鎌" in a name.
_Kanzou_ is written as 寒造:
- "寒": Cold
- "造": Create, Construct
	- He was named for the Japanese name of the jellyfish, サムクラゲ (*Samu Kurage*)- translating to cold jellyfish. Using "造" gave me a way to make the name phonetically similar to his first one.

# Fun Facts
---
- Kanzou was once referred to as:
	- Yamamoto Rankou (山本卵黄)
		- *Yamamoto* (山本) being a common Japanese last name
		- *Rankou* (卵黄) having the characters for egg (卵) and yellow (黄) (referring to the egg yolk)
		- I eventually changed this name because I felt it wasn't a very good Japanese name. At the time, it mainly reflected the name in English and I didn't like that very much. 
- 
